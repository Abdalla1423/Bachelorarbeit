...
A fact checker willdecompose the claim into 2 subclaims that are easier to verify:
1. The Trans-Pacific Partnership is going to generate jobs.
2. The jobs generated by the Trans-Pacific Partnership are better-paying and more stable.

To verify subclaim 1, a fact-checker will go through a step-by-step process to ask and answer a series of questions relevant to its factuality. Here are the specific steps he/she raise each question and look for an answer:
Question: Does the Trans-Pacific Partnership have the potential to generate jobs?
Tell me if you are confident to answer the question or not. Answer me ‘yes’ or ‘no’: Yes.
Answer: Yes, according to several economic analyses, the Trans-Pacific Partnership has the potential to generate jobs.

To verify subclaim 2, a fact-checker will go through a step-by-step process to ask and answer a series of questions relevant to its factuality. Here are the specific steps he/she raise each question and look for an answer:
Question: Are the jobs generated by the Trans-Pacific Partnership expected to be better-paying and more stable?
Tell me if you are confident to answer the question or not. Answer me ‘yes’ or ‘no’: Yes.
Answer: The claim is partially supported. While some analyses suggest that the Trans-Pacific Partnership could lead to higher wages in certain sectors, others argue that it could also lead to job losses in other sectors. The stability of the jobs generated is also a matter of debate.
